...
function handleTipoChange() {
  ...
  // Reset tutto il form tranne il select tipo
  ...
  const costoMedioInput = document.getElementById('costo_medio');
  const prezzoInput = document.getElementById('prezzo');
  const codiceInput = document.getElementById('codice');
  const possedutoInput = document.getElementById('posseduto');
  const isBoxInput = document.getElementById('is_box');
  const nomeInput = document.getElementById('nome');

  // Reset all groups to hidden and remove required attributes
  ...
  [volumiTotaliInput, volumiPossedutilInput, costoMedioInput, codiceInput].forEach(input => {
  ...
  switch(tipo) {
    case "variant":
      ...
      if (volumiPossedutilabel) volumiPossedutilabel.textContent = "Numero di copie:";
      if (costoMedioInput) costoMedioInput.setAttribute('required', 'required');
    ...
    case "serie":
      ...
      if (volumiPossedutilabel) volumiPossedutilabel.textContent = "Volumi Posseduti:";
      if (volumiTotaliInput) volumiTotaliInput.removeAttribute('readonly');
      if (volumiTotaliInput) volumiTotaliInput.setAttribute('required', 'required');
      if (volumiPossedutilInput) volumiPossedutilInput.setAttribute('required', 'required');
    ...
    case "artbooks_anime":
      ...
      if (prezzoInput) prezzoInput.setAttribute('name', 'prezzo');
      hideVolumiGroups();
      break;
    ...
    case "numeri_yugioh":
      ...
      if (codiceInput) codiceInput.setAttribute('required', 'required');
      if (nomeInput) nomeInput.setAttribute('name', 'nome');
      if (prezzoInput) prezzoInput.setAttribute('name', 'prezzo');
      hideVolumiGroups();
      break;
